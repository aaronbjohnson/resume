...
var HTMLgithub = "<li class='flex-item'><a href='https://github.com/aj65461' target='_blank'><img src='images/Git.png ' alt='github-icon' class='socialLogo'></img></a></li>";
...
var HTMLonlineURL = "<br><a id='onlineUrl' href='#'>%data%</a>";//Added onlineUrl to allow control over url color
...
function initializeMap() {
  ...
  var mapOptions = {
    /* Disabled the line below to alow me to add the map style below */
    /*disableDefaultUI: true*/

    /*
    Added 'styles' code below to add a style to the map.
    Website: http://snazzymaps.com/style/111/the-propia-effect
